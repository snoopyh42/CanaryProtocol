...
def get_market_indicators():
    ...
    try:
        ...
        gold_change = ((gold_data['Close'].iloc[-1] /
                       gold_data['Close'].iloc[0]) - 1) * 100
        ...
        dxy_change = ((dxy_data['Close'].iloc[-1] /
                      dxy_data['Close'].iloc[0]) - 1) * 100
...
def get_crypto_indicators():
    ...
    try:
        ...
        btc_change = ((btc_data['Close'].iloc[-1] /
                      btc_data['Close'].iloc[0]) - 1) * 100
