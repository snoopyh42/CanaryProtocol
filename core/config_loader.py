    ...
    def _get_hardcoded_defaults(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "monitoring": {
                ...
                "economic_indicators": ["VIX", "GLD", "DXY", "BTC-USD"],
                "political_keywords": ["election fraud", "constitutional crisis", "martial law"],
                "economic_keywords": ["bank failures", "hyperinflation", "currency collapse"]
            },
            "notifications": {
